...
class ProfileField extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			['varname', 'match', 'pattern' => '/^[A-Za-z_0-9]+$/u', 'message' => UserModule::t("Variable name may consist of A-z, 0-9, underscores, begin with a letter.")],
			['varname', 'unique', 'message' => UserModule::t("This field already exists.")],
			...
			['id, varname, title, field_type, field_size, field_size_min, required, match, range, error_message, other_validator, default, widget, widgetparams, position, visible', 'safe', 'on' => 'search'],
		);
	}
