...
");
?>
<h1>GInitializr Model Generator</h1>
...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'generateAudit'); ?>
        <?php echo $form->checkBox($model, 'generateAudit', ['value' => 1]); ?>
        <div class="tooltip">
            Incluye el behavior de auditoria
        </div>
        <?php echo $form->error($model, 'generateAudit'); ?>
    </div>	
    <div class="row">
        <?php echo $form->labelEx($model, 'messageSupport'); ?>
        <?php echo $form->checkBox($model, 'messageSupport', ['value' => 1]); ?>
        <div class="tooltip">
            Se le aplica la función t() a todas las cadenas del modelo
        </div>
